...
$retour_total=$mysqli->query('SELECT COUNT(*) AS total FROM communike'); //Nous récupérons le contenu de la requête dans $retour_total$mem = mysqli_fetch_assoc($members);
...
// La requête sql pour récupérer les messages de la page actuelle.
    ...
    $result = $mysqli->query('SELECT * FROM communike ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
?>
    <div class="row">
...
<table class="table">
  <thead class="btn-light">
     ...
     while ($mem = mysqli_fetch_assoc($result)):
        ...
        echo '<tr>';
           echo '<td>'.$mem['id'].'</td>';
           echo '<td>'.$mem['titre'].'</td>';
           echo '<td>'.$mem['contenu'].'</td>';
           echo '<td>'.$mem['signe'].'</td>';
           echo '<td>
                    <a class="btn btn-small btn-primary"
                       data-toggle="modal"
                       data-target="#example"
                       data-whatever="'.$mem['id'].' ">Read</a>
                 </td>';
            echo '<td>
