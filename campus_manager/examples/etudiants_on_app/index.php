...
<div class="container">
    ...
    <h1>Table Etudiants inscrit sur L'appication Mobile</h1>
    <br><br>
...
$retour_total=$mysqli->query('SELECT COUNT(*) AS total FROM membres'); //Nous récupérons le contenu de la requête dans $retour_total$mem = mysqli_fetch_assoc($members);
...
// La requête sql pour récupérer les messages de la page actuelle.
    ...
    $result = $mysqli->query('SELECT * FROM membres ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
?>
    <div class="row">
           ...
           echo '<td>'.$mem['pass'].'</td>';
            echo '<td>
                    <a class="btn btn-small btn-danger"
                       data-toggle="modal"
                       data-target="#ex"
                       data-whatever="'.$mem['id'].' ">Supprimer</a>
                 </td>';
