...
<select name="role" id="role" class="form-control ">
  <option class="form-control card">--Changer le rôle</option>
   <option value="SENATEUR" class="form-control card">SENATEUR</option>
    <option value="user" class="form-control card">UTILISATEUR</option>                        
</select>    

<input type="submit" class="btn btn-info" name="dak" value="Appliquer">
</p>
  </form>
    <?php
$id = $_GET['id'];
//echo $id;
    extract ($_POST);
    if (!empty($dak)) {
      $req = $bdd->prepare('UPDATE membres SET role = :nvrole WHERE id = :id');
$req->execute(array(
'nvrole' => $role,
'id' => $id
));
