...
<div class="content">
  <div class="card">
    <div class="container">
<br>
<form method="POST" action="senateur.php">
<div class="container">
  <div class="row">
    

<div class="form-group col-md-3">
<p>Matricule <span>*</span></p>
<input type="text" class="form-control" name="titi" placeholder="Matricule" value="" required>
</div>
<input type="submit" name="ok" class="btn btn-info" value="Chercher">
  </div>
</form>
...
$result = $mysqli->query('SELECT * FROM membres WHERE matricule = \''.$_POST['titi'].'\'');
...
echo '<table class="table">';
  echo '<thead class="btn-primary">';
    ...
    echo  '<th scope="col">Modifier</th>';
        ...
        echo '<tr>';
           echo '<td>'.$mem['nom'].'</td>';
           echo '<td>'.$mem['matricule'].'</td>';
           echo '<td>'.$mem['role'].'</td>'; 
           echo '<td>
           <form action="./senateurs.php" method="GET">
           <input type="hidden" name="id" value="'.$mem['id'].'"/>
           <input type="submit" class="btn btn-success" name="ok" value="Modifier">
      </form>
                 </td>'; 
        echo '</tr>';
