...
$retour_total=$mysqli->query('SELECT COUNT(*) AS total FROM prof'); //Nous récupérons le contenu de la requête dans $retour_total$mem = mysqli_fetch_assoc($members);
...
// La requête sql pour récupérer les messages de la page actuelle.
    ...
    $result = $mysqli->query('SELECT * FROM prof ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
?>
    <div class="row">
